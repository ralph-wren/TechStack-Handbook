...
- [Hadoop 高级特性](#hadoop-高级特性)
  - [高可用性](#高可用性)
    - [HDFS高可用](#hdfs高可用)
      - [1. NameNode高可用架构](#1-namenode高可用架构)
      - [2. JournalNode配置](#2-journalnode配置)
      - [3. 自动故障切换](#3-自动故障切换)
    - [YARN高可用](#yarn高可用)
      - [1. ResourceManager高可用](#1-resourcemanager高可用)
      - [2. 状态存储配置](#2-状态存储配置)
  - [安全性](#安全性)
    - [Kerberos认证](#kerberos认证)
      - [1. Kerberos配置](#1-kerberos配置)
      - [2. 服务主体配置](#2-服务主体配置)
      - [3. 用户认证](#3-用户认证)
    - [访问控制](#访问控制)
      - [1. HDFS权限控制](#1-hdfs权限控制)
      - [2. YARN队列权限](#2-yarn队列权限)
  - [扩展功能](#扩展功能)
    - [HDFS Federation](#hdfs-federation)
      - [1. Federation架构](#1-federation架构)
      - [2. ViewFS配置](#2-viewfs配置)
    - [数据压缩](#数据压缩)
      - [1. 压缩编解码器](#1-压缩编解码器)
      - [2. 压缩配置](#2-压缩配置)
    - [数据格式优化](#数据格式优化)
...
- [Hadoop 典型面试题与答疑](#hadoop-典型面试题与答疑)
  - [基础概念面试题](#基础概念面试题)
    ...
    - [2. HDFS架构](#2-hdfs架构)
    - [3. MapReduce原理](#3-mapreduce原理)
  - [高级特性面试题](#高级特性面试题)
    - [4. HDFS高可用](#4-hdfs高可用)
    - [5. YARN资源调度](#5-yarn资源调度)
    - [6. 数据倾斜处理](#6-数据倾斜处理)
  - [性能优化面试题](#性能优化面试题)
    - [7. HDFS性能优化](#7-hdfs性能优化)
    - [8. MapReduce性能优化](#8-mapreduce性能优化)
    - [9. 内存管理](#9-内存管理)
  - [运维管理面试题](#运维管理面试题)
    - [10. 集群监控](#10-集群监控)
    - [11. 故障排查](#11-故障排查)
