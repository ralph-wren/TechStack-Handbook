...
- [ClickHouse](#clickhouse)
  ...
  - [数据操作](#数据操作)
    ...
    - [JSON 数据写入与解析](#json-数据写入与解析)
      ...
      - [INSERT 示例：JSONEachRow](#insert-示例jsoneachrow)
      - [解析与查询：JSONExtract\* 与 JSON\_VALUE](#解析与查询jsonextract-与-json_value)
...
#### 解析与查询：JSONExtract* 与 JSON_VALUE
