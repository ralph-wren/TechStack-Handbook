  ...
  - [ClickHouse 存储引擎](#clickhouse-存储引擎)
    - [MergeTree 系列引擎](#mergetree-系列引擎)
      - [MergeTree引擎基础](#mergetree引擎基础)
        - [核心工作原理](#核心工作原理)
        - [基本MergeTree表创建](#基本mergetree表创建)
        - [MergeTree引擎关键特性详解](#mergetree引擎关键特性详解)
      - [MergeTree系列引擎变体](#mergetree系列引擎变体)
        - [ReplacingMergeTree - 数据去重引擎](#1-replacingmergetree---数据去重引擎)
        - [SummingMergeTree - 自动聚合引擎](#2-summingmergetree---自动聚合引擎)
        - [AggregatingMergeTree - 复杂聚合引擎](#3-aggregatingmergetree---复杂聚合引擎)
        - [CollapsingMergeTree - 数据变更引擎](#4-collapsingmergetree---数据变更引擎)
        - [VersionedCollapsingMergeTree - 版本化变更引擎](#5-versionedcollapsingmergetree---版本化变更引擎)
        - [GraphiteMergeTree - 时序数据引擎](#6-graphitemergetree---时序数据引擎)
      - [MergeTree引擎高级配置](#mergetree引擎高级配置)
        - [索引和投影优化](#1-索引和投影优化)
        - [TTL和数据生命周期管理](#2-ttl和数据生命周期管理)
        - [存储策略和多磁盘配置](#3-存储策略和多磁盘配置)
...
##### 5. VersionedCollapsingMergeTree - 版本化变更引擎
