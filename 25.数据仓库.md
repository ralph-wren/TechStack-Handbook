...
INSERT INTO orders_delta VALUES 
    ('O001', 'C001', '2023-12-25', 199.99, 'completed');
...
-- 表结构演化
ALTER TABLE orders_delta ADD COLUMN discount_amount DECIMAL(10,2);
```
...
public class RealtimeOrderProcessor {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<String> orderStream = env
            .addSource(new FlinkKafkaConsumer<>("orders_topic", new SimpleStringSchema(), props))
        ...
        DataStream<EnrichedOrderMetrics> enrichedMetrics = metrics
            .connect(customerDimStream)
            .keyBy(OrderMetrics::getCustomerId, Customer::getCustomerId)
            .process(new OrderEnrichFunction());
        
        // 5. 写入结果表
        enrichedMetrics.addSink(new HiveSink());
    ...
    public static class OrderAggregateFunction 
        ...
        public OrderAccumulator add(Order order, OrderAccumulator acc) {
            ...
            acc.customerId = order.getCustomerId();
            return acc;
        }
