...
- [Spark 核心组件与原理](#spark-核心组件与原理)
  ...
  - [内存管理](#内存管理)
    ...
    - [内存优化最佳实践](#内存优化最佳实践)
      ...
      - [3. 监控与诊断](#3-监控与诊断)
    - [内存管理面试题](#内存管理面试题)
      - [Q1: Spark内存分为哪几个部分？](#q1-spark内存分为哪几个部分)
      - [Q2: 如何解决Spark OOM问题？](#q2-如何解决spark-oom问题)
      - [Q3: 什么时候使用缓存？什么时候不使用？](#q3-什么时候使用缓存什么时候不使用)
  - [容错机制](#容错机制)
...
- [Spark 典型面试题与答疑](#spark-典型面试题与答疑)
  - [常见面试题归纳](#常见面试题归纳)
    - [基础概念类面试题](#基础概念类面试题)
      - [Q1: RDD、DataFrame、Dataset的区别是什么？](#q1-rdddataframedataset的区别是什么)
      - [Q2: Spark的宽依赖和窄依赖有什么区别？](#q2-spark的宽依赖和窄依赖有什么区别)
    - [性能优化类面试题](#性能优化类面试题)
      - [Q3: 如何解决Spark数据倾斜问题？](#q3-如何解决spark数据倾斜问题)
      - [Q4: Spark内存管理机制是怎样的？](#q4-spark内存管理机制是怎样的)
      - [Q5: 什么情况下使用广播变量？](#q5-什么情况下使用广播变量)
    - [架构原理类面试题](#架构原理类面试题)
      - [Q6: Spark任务提交流程是怎样的？](#q6-spark任务提交流程是怎样的)
      - [Q7: Shuffle的原理和优化方法？](#q7-shuffle的原理和优化方法)
      - [Q8: Spark的容错机制是如何实现的？](#q8-spark的容错机制是如何实现的)
    - [实战应用类面试题](#实战应用类面试题)
      - [Q9: 如何优化Spark SQL查询性能？](#q9-如何优化spark-sql查询性能)
      - [Q10: Spark Streaming和Flink有什么区别？](#q10-spark-streaming和flink有什么区别)
      - [Q11: 如何监控和调优Spark应用？](#q11-如何监控和调优spark应用)
    - [高级特性类面试题](#高级特性类面试题)
      - [Q12: Spark的广播变量和累加器有什么区别？](#q12-spark的广播变量和累加器有什么区别)
      - [Q13: Spark的Checkpoint和Cache有什么区别？](#q13-spark的checkpoint和cache有什么区别)
      - [Q14: 如何实现Spark的自定义分区器？](#q14-如何实现spark的自定义分区器)
    - [故障排查类面试题](#故障排查类面试题)
      - [Q15: Spark应用出现OOM如何排查？](#q15-spark应用出现oom如何排查)
      - [Q16: Spark任务执行缓慢如何分析？](#q16-spark任务执行缓慢如何分析)
    - [面试技巧总结](#面试技巧总结)
      - [回答要点：](#回答要点)
      - [准备建议：](#准备建议)
- [Spark 源码解析](#spark-源码解析)
  ...
  - [任务提交流程源码解析（细节补充）](#任务提交流程源码解析细节补充)
    ...
    - [6. 典型源码流程图](#6-典型源码流程图)
- [Spark 常见任务报错及解决办法](#spark-常见任务报错及解决办法)
  - [内存相关错误](#内存相关错误)
